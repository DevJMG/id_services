                ...
                <div class="row">
                    ...
                    <div class="print_con pt-4">
                        ...
                        <button id="btn_reuse" class="btn btn-lg btn-success">
                           <i class="fa fa-print"></i> Print (PVC ID)
                        </button>
                        <button id="btn_manual" class="btn btn-lg btn-danger">
                           <i class="fa fa-download"></i> Print (Temp. ID)
                        </button>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $("#btn_manual").click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                        if(data == 'Data Exist'){
                            $(location).attr('href','print_form2.php?SN='+id_id);
                        } else {
                            $("#msg_alert").show();
                            $("#msg_alert").removeClass("bg-success");
                            $("#msg_alert").addClass("bg-danger");
