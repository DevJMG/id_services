...
<section class="container">
    ...
    <div class="row py-5">
        ...
        <div class="col-lg-12">
            <h2 class="pb-3"><strong>ID Services > <span class="text-danger">Personnel</span></strong></h2>

            <div class="col-lg-12">
                <label class="pb-1"><strong>Service Reference Number (SRN) or Last Name:</strong></label>
                <div class="input-group input-group-lg mb-3">
                  <input type="text" id="sr_number" class="form-control" placeholder="e.g. IDP11282022_001 or Garcia" aria-label="" aria-describedby="sr_btn">
